            ...
            <div class="row align-items-center">
                <div class="col-12 col-sm-6">
                    <div class="hero-content">
                        ...
                        <a class="hero-button" href="/register" rel="noopener"><i
            ...
            <div class="row align-items-center">
                <div class="col-sm-6">
                    <div class="feature-list-image">
                        <img data-src="img/android.png" class="img-fluid" alt="Official android logo"
                            width="300" height="50%">
                    </div>
                </div>
    ...
    <section class="section-spacer">
        <div class="container">
            <div class="row flex-column-reverse flex-sm-row align-items-cengit ter">
                ...
                <div class="col-sm-6">
                    <div class="feature-list-image">
                        <img data-src="img/web.png" alt="Developer building a progressive web app"
    ...
    <section id="hip" class="section-spacer">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-sm-6">
                    <div class="feature-list-image">
                        <img data-src="img/cloud.png" class="img-fluid" alt="Illustration of data uploading to the cloud"
                            width="90%">
                    </div>
                </div>
                <div class="col-sm-5 ml-auto wow fadeInUp">
    ...
    <section class="section-spacer">
        <div class="container">
            <div class="row flex-column-reverse flex-sm-row align-items-cengit ter">
                ...
                <div class="col-sm-6">
                    <div class="feature-list-image">
                        <img data-src="img/mi.png" class="img-fluid" alt="Robotic illustration of how many different things it can do"
                            height="60%" width="90%">
                    </div>
                </div>
            </div>
                                    ...
                                    <div class="card hovercard">
                                        ...
                                        <div class="bottom">
                                            <ul class="social-list__inline mt-10">
                                                ...
                                                <li>
                                                    <a href="https://www.linkedin.com/in/grishon-nganga-8426b5149/" target="_blank"
                                                        rel="noopener">
                                                        <i class="fab fa-linkedin"></i>
                                                    </a>
                                                </li>
