...
<nav class="navbar navbar-expand-lg fixed-top custom-menu custom-menu__light">
    <div class="container">
        <a class="navbar-brand" href="#">
            <img src="img/dsc-logo.png" height="35" alt="Image">
    </a>
 ...
 <div class="container">
        <div class="row align-items-center">
            <div class="col-12 col-sm-6">
                <h2 div="err-p">Calm down<br> We'll be right back</h2><br>
                <a href="/" class=" hero-button event-btn err">Return to Home</a>
            </div>

             <div class="col-12 col-sm-5 error">
                <img  class=" mt-5 err-img" src="img/const.gif" alt="illustration of error 404 message">
            </div>
